...
export default function CsChatbotError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[CS Chatbot Error]", error)
  }, [error])
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-20">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-xl font-semibold">챗봇을 불러올 수 없습니다</h2>
        <p className="text-sm text-muted-foreground max-w-md">
          CS 챗봇을 로드하는 중 오류가 발생했습니다. 다시 시도해주세요.
        </p>
        {error.digest && (
